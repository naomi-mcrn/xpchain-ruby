= XPChain-ruby (forked from bitcoin-ruby)

This is a ruby library for interacting with the XPChain protocol/network.

(bitcoin-ruby + xpchain specific feature)
...
== Installation
 ...
 # OR
 git clone https://github.com/naomi-mcrn/bitcoin-ruby.git; cd bitcoin-ruby; bundle install
...
If you would like to install using Bundler, put it in your Gemfile and run bundle install
 gem 'bitcoin-ruby', git: 'https://github.com/naomi-mcrn/bitcoin-ruby', branch: 'master', require: 'bitcoin'
