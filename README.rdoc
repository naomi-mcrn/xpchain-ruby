...
== Installation
 ...
 (no rubygem package!)
 git clone https://github.com/naomi-mcrn/xpchain-ruby.git; cd xpchain-ruby; bundle install
...
If you would like to install using Bundler, put it in your Gemfile and run bundle install
 gem 'xpchain-ruby', git: 'https://github.com/naomi-mcrn/xpchain-ruby', branch: 'master', require: 'bitcoin'
